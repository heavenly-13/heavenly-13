...
- **Morrowind Mod:** [jvk1166z.esp - The Haunted Morrowind Mod](https://www.nexusmods.com/morrowind/mods/53119) - June 2023
  ...
  - **Creation:** Developed using a combination of scripting languages and modding tools specific to the Morrowind game engine. Employed techniques such as level design, quest scripting, asset integration and sound design to bring the atmosphere to life. Made by tweaking a deprecated version of a similar mod, combining it with various community efforts and fixing localization, texture and consistency issues. Ensured compatibility with an open source engine.
